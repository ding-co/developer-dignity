...
cron.schedule('2 * * * *', () => {
  console.log('매 시간의 2분마다 작업이 실행됩니다.'); // 8시 2분, 9시 2분
});

cron.schedule('1,2,4,5 * * * *', () => {
  console.log('매 시간의 1,2,4,5분마다 작업이 실행됩니다.'); // 8시 1분, 8시 2분, 8시 4분, 8시 5분, 9시 1분, 9시 2분, ...
});

cron.schedule('1-5 * * * *', () => {
  console.log('매 시간의 1,2,3,4,5분마다 작업이 실행됩니다.'); // 8시 1분, 8시 2분, 8시 3분, 8시 4분, 8시 5분, 9시 1분, ...
});
...
cron.schedule('0 21 * * * ', () => {
  console.log('매일 밤 09:00에 작업이 실행됩니다.');
});
...
const task = cron.schedule(
  ...
  { scheduled: false } // start() 함수가 호출되어야 실행됨
);
